<%@page import="modeloDTO.Actividad"%>
...
<html lang="en">
  ...
  <c:set var="actividad" value="${requestScope.actividad}" />
    ...
    <form class="container" method="POST" action="ModificarActividad">
        ...
        <div class="mb-3">
          ...
          <select name="id_zona" id="zona" class="form-select">
            <c:forEach items="${ zonas }" var="zona">
              <c:choose>
              	<c:when test="${ actividad.zona.id == zona.id}">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="cantidad_max" name="cantidad_max" value="${ actividad.cantidad_max }">
        </div>
        <div class="mb-3">
            <label for="edad_min" class="form-label">Edad Minima</label>
            <input type="number" class="form-control" id="edad_min" name="edad_min" value="${ actividad.edad_min }">
          </div>
