...
<html lang="en">
  ...
  <c:set var="zona" value="${requestScope.zona}" />
    <h1 class="text-center">Modificar Zona</h1>
    <form class="container" method="POST" action="ModificarZona">
    	<input type="hidden" id="id" name="id" value="${zona.id }" />
        <div class="mb-3">
